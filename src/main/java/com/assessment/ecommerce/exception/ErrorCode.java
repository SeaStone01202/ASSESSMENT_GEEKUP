...
public enum ErrorCode {
    ...
    INSUFFICIENT_STOCK(504, "Sản phẩm vượt quá tồn kho", HttpStatus.BAD_REQUEST),
    ...
    STORE_NOT_FOUND(404, "Store not found", HttpStatus.NOT_FOUND),
    PAYMENT_METHOD_NOT_SUPPORTED(400, "Payment method not supported", HttpStatus.NOT_FOUND);
    ;
